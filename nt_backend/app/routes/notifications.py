...
@router.post("/")
def post_notifications(title: str, message: str, platform: str, user_id: int, service: NotificationService = Depends()):
    return service.post_notifications(title, message, platform, user_id)
